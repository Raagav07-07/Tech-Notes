...
Here for example: It->`[1,0]`, Animal->`[1,0]`,Road->`[0,0]`.

Then the dot product of 'it' with 'animal' and 'it' with 'road' are given by,
[(1x1)+(0x0)] = 1 (Animal) , [(1x0)+(0x0)] = 0 (Road). 

So the animal has more relevance.
